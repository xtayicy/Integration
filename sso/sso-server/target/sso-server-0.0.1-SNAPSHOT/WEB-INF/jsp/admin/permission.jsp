...
<link rel="stylesheet" href="${_staticPath}/static/css/metroStyle/metroStyle.css?v=1" />
<link rel="stylesheet" href="${_staticPath}/static/css/metroStyle/metroStyle.custom.css" />
<style type="text/css">
...
<script type="text/javascript">
	scripts.push(
			"${_staticPath}/static/js/jquery.ztree.core-3.5.min.js?v=" + Math.random(),
			"${_staticPath}/static/js/jquery.ztree.excheck-3.5.min.js?v=" + Math.random());
